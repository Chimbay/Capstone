 ...
 * @param original — the full document text as it was loaded from disk, never mutated
 * @paramadd — all text inserted during the current session, only ever appended to
 */
